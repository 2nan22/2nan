...
class TestView(TestCase):
    def setUp(self):
        ...
        self.user_trump = User.objects.create.user(username='trump',
        password='somepassword')
        self.user_obama = User.objects.create.user(username='obama',
        password='somepassword')
